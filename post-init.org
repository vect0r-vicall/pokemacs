...
Use window key switch to move across windows

#+begin_src emacs-lisp
  (windmove-default-keybindings 'super)
#+end_src

Enable CUA mode (copy/paste with c/v/x)

#+begin_src emacs-lisp
  (cua-mode t)
#+end_src

Remap undo/vundo shortcuts
...
Bind multi-cursor mode, on top of C-c C-m.
...
Set print key as M-x on Lenovo Carbon X1
